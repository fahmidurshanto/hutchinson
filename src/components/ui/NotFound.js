        ...
        <div className="w-full min-h-[70vh] flex flex-col items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="relative z-10 text-center max-w-xl animate__animated animate__fadeIn">
                <div className="mb-8 relative inline-block">
                    <div className="text-[120px] font-black text-gray-100 leading-none select-none tracking-tighter opacity-50">404</div>
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-20 h-20 rounded-full border-2 border-[#D4AF37]/30 flex items-center justify-center bg-white shadow-xl">
                ...
                <h1 className="text-3xl md:text-4xl font-black text-gray-900 uppercase tracking-tight mb-4 leading-tight">
                    {title}
                </h1>
                ...
                <div className="mt-16 pt-8 border-t border-gray-100">
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.4em] opacity-60 italic">Hutchinson APAC • Privilege Redefined</p>
                </div>
            </div>
        </div>
    );
