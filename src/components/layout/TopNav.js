    ...
    return (
        <header className="fixed top-0 left-0 w-full h-20 bg-gradient-silver-horizontal flex items-center z-50 px-4 md:px-8 shadow-sm"
            ...
            <div className="ml-auto flex items-center space-x-4">
                ...
                {/* Logout Button */}
                <Link href="/login" className="w-10 h-10 rounded-full flex items-center justify-center text-gray-500 hover:text-red-500 hover:bg-red-50 transition-colors" title="Logout">
