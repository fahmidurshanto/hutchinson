                ...
                <div className="relative z-10 w-full px-4 max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    <div className="w-full max-w-[340px] bg-white rounded-[2.5rem] border border-amber-100 shadow-2xl shadow-amber-900/5 overflow-hidden animate__animated animate__fadeInRight">
                        <div className="bg-gradient-to-r from-[#D4AF37] to-[#F2D472] py-2 px-4 text-center">
                            <span className="text-3xl py-12 bold font-black uppercase tracking-tight text-gray-800 leading-tight">Grand Total</span>
                        </div>
                        <div className="p-8 text-center bg-[#fdfaf1]/50">
                            <div className="flex items-center justify-center gap-3">
                                <span className="text-4xl md:text-5xl font-black text-[#D4AF37]">£</span>
                                <span className="text-4xl md:text-4xl font-black text-gray-900 tracking-tight">
