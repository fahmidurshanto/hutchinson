...
const financialData = [
    { label: 'REALTY ACCESS LIMITED', value: 'USD 5,000' },
    { label: 'CONCEPTS VACATION CLUB', value: 'USD 6,000' },
    { label: 'CLUB EMPEROR', value: 'USD 5,000' },
];

const totalDisbursement = 'USD 16,000'; // Sum of the above for demonstration
